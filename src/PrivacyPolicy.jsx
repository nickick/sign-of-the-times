  ...
  return (
    ...
    >
      <section id="content" style={{ width: "100%" }}>
        <div
          id="post-6840"
          className="post-6840 page type-page status-publish hentry"
        >
          <span className="entry-title rich-snippet-hidden">Privacy Policy</span>
          <span className="vcard rich-snippet-hidden">
            <span className="fn">
              <a
                href="mailto:nick@nickhong.xyz"
                title="Email for Nick Hong"
                rel="author"
              >
                Nick Hong
              </a>
                  ...
                  <strong>
                    <span style={{ fontSize: 15 }}>
                      <span data-custom-class="subtitle">
                        Last updated <bdt className="question">November 24, 2020</bdt>
                      </span>
                    </span>
                  </strong>
                </span>
                ...
                <span style={{ color: "rgb(127, 127, 127)" }}>
                  <span style={{ color: "rgb(89, 89, 89)", fontSize: 15 }}>
                    <span data-custom-class="body_text">
                      ...
                      <bdt className="question">Signs of the Times</bdt>
                    ...
                    <span data-custom-class="body_text">
                      ...
                      contact us at{" "}
                      <bdt className="question">privacy@brendannorth.com</bdt>.
                    </span>
                  </span>
                </span>
              </div>
                ...
                <span style={{ fontSize: 15 }}>
                  <span style={{ color: "rgb(127, 127, 127)" }}>
                    <span data-custom-class="body_text">
                      ...
                      visit our website{" "}
                      <bdt className="question">https://www.signs-of-the-times.xyz</bdt> (the “
                                ...
                                >
                                  ...
                                  >
                                    <span data-custom-class="body_text">
                                      ...
                                      process, such as in response to a court order or
                                      a subpoena (including in response to public
                                ...
                                >
                                  ...
                                  >
                                    <span data-custom-class="body_text">
                                      ...
                                      disclose your information where we believe it is
                                            ...
                                            >
                                              <span data-custom-class="body_text">
                                                ...
                                                <em>
                                                  ...
                                                  your information in countries other
                                                  than your own.
                                                </em>
                                              </span>
                                            </span>
                                          ...
                                          >
                                            ...
                                            >
                                              <span data-custom-class="body_text">
                                                ...
                                                facilities and by those third parties
                                                with whom we may share your personal
                                                information (see “
                                                <a
                                          ...
                                          >
                                            ...
                                            >
                                              <span data-custom-class="body_text">
                                                ...
                                                Economic Area, then these countries
                                                may not necessarily have data
                                                protection laws or other similar laws
                                                as comprehensive as those in your
                                                country. We will however take all
                                                necessary measures to protect your
                                          ...
                                          >
                                            ...
                                            >
                                              <span data-custom-class="body_text">
                                                ...
                                                or market to children under 18 years
                                                of age. By using the{" "}
                                                <span
                                                  style={{
                                                    color: "rgb(89, 89, 89)",
                                                ...
                                                >
                                                  <span data-custom-class="body_text">
                                                    <span style={{ fontSize: 15 }}>
                                                      <a
                                                        data-custom-class="link"
                                                        href="https://app.termly.io/notify/f0e3688f-f2b3-4677-9913-1e423e484720"
                                                        rel="noopener noreferrer"
                                                        target="_blank"
                                                      >
                                                        here
